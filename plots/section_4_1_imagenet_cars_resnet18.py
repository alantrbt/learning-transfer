...
def section_4_1_imagenet_cars_resnet18(cfg, outman, prefix, gpu_id):
    datas = []

    # ==== Load data ====
    exp_name = 'transfer_imagenet-cars_resnet18_usetarget'
    ...
    exp_name = 'transfer_imagenet-cars_resnet18_noperm'
    ...
    exp_name = 'transfer_imagenet-cars_resnet18'
    label = 'GMT Transfer'
    color = 'C0'
    prefix_list = ['0e9075eca7f28c55fdc0505cfde0f6fe',
                    'f1f5787e9d2e63f1f58f0014cddca7e9',
    ...
    exp_name = 'transfer_imagenet-cars_resnet18_fast'
    label = 'FGMT Transfer'
    color = 'C2'
    linestyle = '-'
    prefix_list = ['0e9075eca7f28c55fdc0505cfde0f6fe',
    ...
    name = f'section_4-1_imagenet-cars_resnet18'
