...
def section_4_2_cifar10_cifar100_conv8(cfg, outman, prefix, gpu_id):
    datas = []
    ...
    name = f'section_4-2_cifar10-cifar100_conv8'
    ...
    filepath = outman.get_abspath(prefix='plot.finetuning', ext='png', name=name)
    fig = plt.figure()
