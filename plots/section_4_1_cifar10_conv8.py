...
def section_4_1_cifar10_conv8(cfg, outman, prefix, gpu_id):
    datas = []
    ...
    color = 'C3'
    linestyle = '-.'
    prefix_list = ["755a29296de52a7cd50c870e3137d856",
                    "4960937260f3e3cd8b4bf032dcc17de0",
                    "c75eaaf5fc4efb99b59a704d8e207a8a",
                    ]
    ...
    color = 'C2'
    linestyle = '-'
    prefix_list = ['970ef6a0ad9b287e7b33740c2092af1c',
                    '8f1c24ae3e2f681f2f7f4dc7c095c073',
                    '68031b414c66eba92a8723e3ea96c6eb',
                    ]
    data = load_data(cfg['output_dir'], 'transfer_results', exp_name, prefix_list, color=color, label=label, linestyle=linestyle)
    datas.append(data)
    ...
    name = f'section_4-1_init-cifar10_conv8'
