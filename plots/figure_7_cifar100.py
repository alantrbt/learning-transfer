"""Figure 7 — Scratch vs Transfer vs Ground-truth: CIFAR-100 / Conv8."""
import glob
import os
import json
import torch
...
def figure_7_cifar100(cfg, outman, prefix, gpu_id):
    output_dir = cfg['output_dir']

    scratch_scores = _load_best_val_scores(output_dir, 'cifar100-1_conv8_sgd')
    transfer_accs = _load_transfer_final_accs(output_dir, 'transfer_cifar10-cifar100_conv8')
    gt_scores = _load_best_val_scores(output_dir, 'cifar10_to_cifar100-1_conv8_sgd')
    ...
    ax.set_title('CIFAR-100 (split 1) — Conv8')
