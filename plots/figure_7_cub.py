"""Figure 7 — Scratch vs Transfer vs Ground-truth: CUB-200 / ResNet-18."""
import glob
import os
import json
import torch
...
def figure_7_cub(cfg, outman, prefix, gpu_id):
    output_dir = cfg['output_dir']

    scratch_scores = _load_best_val_scores(output_dir, 'cub_resnet18_sgd')
    transfer_accs = _load_transfer_final_accs(output_dir, 'transfer_imagenet-cub_resnet18')
    gt_scores = _load_best_val_scores(output_dir, 'imagenet_to_cub_resnet18_sgd')
    ...
    ax.set_title('CUB-200-2011 — ResNet-18')
